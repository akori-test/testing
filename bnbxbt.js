...
// Configuration
const TARGET_ACCOUNT = 'bnbxbt_agent';
...
const USER_DATA_DIR = path.join(__dirname, 'chrome_profile_BNBXBT'); // Different directory name
...
const logFilePath = path.join(OUTPUT_DIRECTORY, `bnbxbt_tracker_log_${sessionId}.json`);
...
async function updateNocoDB(totalMentions) {
  try {
    ...
    const data = {
      ...
      token_name: 'BNBXBT',
      token_id: '0xA18BBdCd86e4178d10eCd9316667cfE4C4AA8717',
