...
// Configuration
const TARGET_ACCOUNT = 'FirstBroccoli';
...
const USER_DATA_DIR = path.join(__dirname, 'chrome_profile_firstbroccoli'); // Different directory name
...
const logFilePath = path.join(OUTPUT_DIRECTORY, `firstbroccoli_tracker_log_${sessionId}.json`);
...
async function updateNocoDB(totalMentions) {
  try {
    ...
    const data = {
      ...
      token_name: 'Broccoli',
      token_id: '0x12B4356C65340Fb02cdff01293F95FEBb1512F3b',
