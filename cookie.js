...
// Configuration
const TARGET_ACCOUNT = 'cookiedotfun';
...
const USER_DATA_DIR = path.join(__dirname, 'chrome_profile_cookie'); // Different directory name
...
const logFilePath = path.join(OUTPUT_DIRECTORY, `cookie_tracker_log_${sessionId}.json`);
...
async function updateNocoDB(totalMentions) {
  try {
    ...
    const data = {
      ...
      token_id: '0xc0041ef357b183448b235a8ea73ce4e4ec8c265f',
