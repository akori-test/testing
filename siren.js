...
// Configuration
const TARGET_ACCOUNT = 'genius_sirenBSC';
...
const USER_DATA_DIR = path.join(__dirname, 'chrome_profile_siren'); // Different directory name
...
async function updateNocoDB(totalMentions) {
  try {
    ...
    const data = {
      ...
      token_name: 'Siren',
      token_id: '0x997a58129890bbda032231a52ed1ddc845fc18e1',
