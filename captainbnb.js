...
// Configuration
const TARGET_ACCOUNT = 'CaptainBNB_bsc';
...
const USER_DATA_DIR = path.join(__dirname, 'chrome_profile_CaptainBNB'); // Different directory name
...
async function updateNocoDB(totalMentions) {
  try {
    ...
    const data = {
      ...
      token_name: 'CaptainBNB',
      token_id: '0x47a1eb0b825b73e6a14807beaecafef199d5477c',
